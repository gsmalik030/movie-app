...
- [Live Demo](https://movie-app-v3rg.onrender.com) 
...
```sh
  cd movie-app
  git clone https://github.com/gsmalik030/movie-app
```
...
Feel free to check the [issues page](https://github.com/gsmalik030/movie-app/issues).
